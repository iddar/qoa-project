...
export function StoreAgentDrawer() {
  ...
  return (
    <>
      ...
      <div
        className={`fixed inset-y-0 right-0 z-50 w-full max-w-[28rem] transform border-l border-zinc-200 bg-white/95 shadow-2xl backdrop-blur transition duration-200 dark:border-zinc-800 dark:bg-zinc-950/95 ${
