                        ...
                        <ul className="divide-y divide-zinc-100 dark:divide-zinc-800/60">
                            {filtered.map((product) => (
                                ...
                                >
                                    ...
                                    <span
                                        className={`inline-flex flex-shrink-0 rounded-full px-2.5 py-0.5 text-[10px] font-semibold uppercase tracking-wide ${
                        ...
                        {brands.length === 0 ? (
                            ...
                            >
                                ...
                                <div>
                                    ...
                                    />
                                    <p className="mt-1 text-xs text-zinc-400">
                                        El SKU debe ser único en toda la plataforma.
                                    </p>
                                </div>
                                ...
                                {createProduct.isError && (
                                    <div className="rounded-lg border border-red-200 bg-red-50 px-3 py-2 dark:border-red-900 dark:bg-red-950/40">
                                        <p className="text-xs text-red-700 dark:text-red-400">
                                            No se pudo crear el producto. El SKU podría estar
                                            duplicado.
                                        </p>
                                    </div>
                                )}
